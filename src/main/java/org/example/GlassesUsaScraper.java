...
//
//public class GlassesUsaScraper extends Thread {
//
...
//                driver.get("https://www.glassesusa.com/salesperson/result?q=glasses");
//                String source = driver.getPageSource();
//                Document doc = Jsoup.parse(source);
//
//                // Get all of the products on the page
//                Elements prods = doc.select(".glassesItem__glassesItem___ywmUg");
//
//                // Work through the products
//                for (int i = 0; i < prods.size(); ++i) {
//
//                    // Get the product description
//                    Elements name = prods.get(i).select(".productTitle__name___tMBxy");
//
//                    // Get the product price
//                    Elements price1 = prods.get(i).select(".priceItem__regularPrice___RvEou");
//
//                    // Get the product link
//                    Elements link = prods.get(i).select(".productTitle__name___tMBxy");
//                    String productLink = "https://www.glassesusa.com" + link.attr("href");
//
//                    // Get the product image
//                    Elements image = prods.get(i).select(".glassesItem__wrapImage___CKApZ img");
...
//                    Elements descriptionElement = productDoc.select(".description__description___iSwvd");
//                    String description = descriptionElement.text();
//                    Elements size = productDoc.select(".sizes__value___J_CBO");
//
